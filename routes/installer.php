...
Route::get('newupdate', 'Installer\NewUpdateController@newupdatelink')->name('admin.newupdate');
Route::get('update/{token}', 'Installer\NewUpdateController@thirdupdate')->name('admin.thirdupdate');
Route::post('updatechecking', 'Installer\NewUpdateController@checking')->name('update.datachecking');
Route::get('seedingData', 'Installer\NewUpdateController@seeding')->name('data.seeding');

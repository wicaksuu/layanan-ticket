										...
										<div class="card-body p-0">
											<div class="border-bottom">
												<ul class="nav-settings settings-menu nav nav-pills d-lg-none d-sm-flex d-block p-3">
													...
													<li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#google"><span class="nav-setting-icon"><i class="fa fa-google"></i></span> <span class="nav-setting-txt">{{lang('Google')}}</span></a></li>
													<li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#facebook"><span class="nav-setting-icon"><i class="fa fa-facebook-f me-1"></i></span> <span class="nav-setting-txt">{{lang('Facebook')}}</span></a></li>
													<li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#twitter"><span class="nav-setting-icon"><i class="fa fa-twitter"></i></span> <span class="nav-setting-txt">{{lang('Twitter')}}</span></a></li>
												</ul>
											</div>
														...
														<li class="nav-item">
															<a class="nav-link active" data-bs-toggle="tab" href="#envato">
																<span class="nav-setting-icon">
                                                                    <svg class="env-icon" style="enable-background:new 0 0 512 512; width: 14px; height: 14px;" version="1.1" viewBox="0 0 512 512" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g id="_x38_5-envato"><g><g><g><path d="M401.225,19.381c-17.059-8.406-103.613,1.196-166.01,61.218      c-98.304,98.418-95.947,228.089-95.947,228.089s-3.248,13.335-17.086-6.011c-30.305-38.727-14.438-127.817-12.651-140.23      c2.508-17.494-8.615-17.999-13.243-12.229c-109.514,152.46-10.616,277.288,54.136,316.912c75.817,46.386,225.358,46.354,284.922-85.231C509.547,218.042,422.609,29.875,401.225,19.381L401.225,19.381z M401.225,19.381"></path></g></g></g></g><g id="Layer_1"></g></svg>
                                                                </span>
																<span class="nav-setting-txt">{{lang('Envato', 'menu')}}</span>
															</a>
														</li>
													...
													<div class="tab-content">
														...
														<div class="tab-pane active" id="envato">
															...
															<div class="p-5 main-settings-content" id="envatoSettings">
																...
																<div class="form-group">
																	...
																	<small class="text-muted"><i>({{lang('Add this callback URL to your "Envato" App settings.', 'setting')}})</i></small>
																</div>
															</div>
														...
														<div class="tab-pane" id="google">
															...
															<div class="p-5 main-settings-content" id="googleSettings">
																...
																<div class="form-group">
																	...
																	<small class="text-muted"><i>({{lang('Add this callback URL to your "Google" App settings.', 'setting')}})</i></small>
																</div>
															</div>
															<div class="px-5 py-4 mt-auto border-top">
																<div class="text-end btn-list">
														...
														<div class="tab-pane" id="facebook">
															...
															<div class="p-5 main-settings-content" id="facebookSettings">
																...
																<div class="form-group ">
																	<label class="form-label">{{lang('Facebook Secret')}}</label>
																...
																<div class="form-group">
																	...
																	<small class="text-muted"><i>({{lang('Add this callback URL to your "Facebook" App settings.', 'setting')}})</i></small>
																</div>
															</div>
															<div class="px-5 py-4 mt-auto border-top">
																<div class="text-end btn-list">
														...
														<div class="tab-pane" id="twitter">
															<div class="px-5 py-4 border-bottom d-flex align-items-center">
																<h5 class="mb-0">{{lang('Twitter Settings')}}</h5>
																<div class="ms-auto">
																	<div class="switch_section p-0 m-0">
																		<div class="switch-toggle d-flex float-end">
																			<a class="onoffswitch2 switch-lg">
															...
															<div class="p-5 main-settings-content" id="twitterSettings">
																<div class="form-group ">
																	<label class="form-label">{{lang('Twitter App ID')}}</label>
																...
																<div class="form-group ">
																	<label class="form-label">{{lang('Twitter Secret')}}</label>
																...
																<div class="form-group">
																	...
																	<small class="text-muted"><i>({{lang('Add this callback URL to your "Twitter" App settings.', 'setting')}})</i></small>
																</div>
															</div>
															<div class="px-5 py-4 mt-auto border-top">
																<div class="text-end btn-list">
